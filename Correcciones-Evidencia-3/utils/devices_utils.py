...
def map_device_data_for_view(device: dict, states: dict, device_types: dict, locations: dict, homes: dict) -> dict:
    """
    ...
    return {
        ...
        'home': get_name_by_id(homes, device['home_id'], id_key='id', name_key='name')
    }
